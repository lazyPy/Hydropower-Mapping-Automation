...
def main():
    ...
    parser.add_argument('--top_n', type=int, default=50, help='Top N site pairs to consider (default: 50)')
    parser.add_argument('--search_radius', type=float, default=500.0, help='Weir search radius (m)')
    parser.add_argument('--min_distance', type=float, default=100.0, help='Minimum distance from inlet (m)')
    parser.add_argument('--elevation_tolerance', type=float, default=20.0, help='Elevation tolerance (m)')
    parser.add_argument('--cone_angle', type=float, default=90.0, help='Directional cone angle (degrees)')
    parser.add_argument('--max_candidates', type=int, default=10, help='Max candidates per inlet')
